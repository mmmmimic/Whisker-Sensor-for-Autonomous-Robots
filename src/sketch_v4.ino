...
void loop()
{
  ...
  unsigned int index[NUM_SENSORS] = { 15, 17, 19 };
  float factors[3] = {20.0, 20.0, 15.0 };
  char message[100];
  ...
  while (true)
  {
    ...
    for (unsigned int i = 0; i < NUM_SENSORS; i++){
      ...
      n++;
      String s = (String)index[i];
      //Serial.println(s);
      String s1 = (String)data.states[0];
      //Serial.println(s1);
      //Serial.println(touch_data[i].real_touch);
      //Serial.println(touch_data[i].touch_value);
      t1 = micros();
